...
const mdComponents: React.ComponentProps<typeof ReactMarkdown>["components"] = {
  ...
  h2: ({ children }) => (
    <h2 className="mt-8 mb-4 text-xl font-semibold tracking-tight text-foreground">
      {children}
    </h2>
  ),
  h3: ({ children }) => (
    <h3 className="mt-6 mb-3 text-lg font-medium text-foreground">{children}</h3>
  ),
  p: ({ children }) => (
  ...
  pre: ({ children }) => (
    <pre className="my-4 overflow-x-auto rounded-lg border bg-slate-900 p-4 text-sm">
      {children}
    </pre>
  ),
  table: ({ children }) => (
